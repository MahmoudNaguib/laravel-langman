...
namespace MahmoudNaguib\Langman\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Arr;
use MahmoudNaguib\Langman\Manager;
...
class FindCommand extends Command
{
     ...
     *
     * @var \MahmoudNaguib\LangMan\Manager
     */
    private $manager;
     ...
     *
     * @param \MahmoudNaguib\LangMan\Manager $manager
     * @return void
     */
        ...
        foreach ($output as $fullKey => $values) {
            ...
            foreach ($allLanguages as $languageKey) {
                if(isset($values[$languageKey])){
                    ...
                    $original[$languageKey]=isset($filesContent[$fileName][$languageKey][$key]) ? $filesContent[$fileName][$languageKey][$key] : '';
                }
            }
